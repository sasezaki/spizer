...
/*
$home = $_SERVER['HOME'];
set_include_path($home. '/tmp/ZF-1.11.5/'.PATH_SEPARATOR.get_include_path());
set_include_path($home. '/diggin/Diggin_Http_Response_Charset/library/'.PATH_SEPARATOR.get_include_path());
set_include_path($home. '/diggin/svn_Diggin_Scraper_Adapter_Htmlscraping/library/'.PATH_SEPARATOR.get_include_path());
set_include_path($home. '/diggin/svn_Diggin/diggin/library/'.PATH_SEPARATOR.get_include_path());
*/
